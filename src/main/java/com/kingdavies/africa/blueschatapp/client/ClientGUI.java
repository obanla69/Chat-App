...
//        messagePanel.add(createChatMessageComponent(new Message()));
    ...
    public void onActiveUsersUpdated(ArrayList<String> users) {
        ...
        for (String user : users) {
            ...
            username.setFont(new Font("Inter", Font.BOLD, 6));
    ...
    private void updateMessageSize() {
        for (int counter = 0; counter < messagePanel.getComponents().length; counter++) {
            Component component = messagePanel.getComponent(counter);
